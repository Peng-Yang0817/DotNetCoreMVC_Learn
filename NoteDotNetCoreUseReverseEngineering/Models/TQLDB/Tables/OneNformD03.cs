...
public partial class OneNformD03
{
    ...
    public string RelatedDepartmentName { get; set; } = null!;
    ...
    public string Comment007 { get; set; } = null!;
    ...
    public string? TotalFullTimeTeacherNumTotal { get; set; }
