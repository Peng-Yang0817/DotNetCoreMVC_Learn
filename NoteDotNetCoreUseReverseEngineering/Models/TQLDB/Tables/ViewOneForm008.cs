...
public partial class ViewOneForm008
{
    ...
    public string State0111name { get; set; } = null!;
    ...
    public string? State0112name { get; set; }
    ...
    public string? State0113name { get; set; }
    ...
    public string? State0114name { get; set; }
    ...
    public string? State0115name { get; set; }
    ...
    public string? State0116name { get; set; }
